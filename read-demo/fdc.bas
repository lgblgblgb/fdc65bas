...
5060 IF A$ = "3" THEN POKE $D6AE, (PEEK($D6AE) XOR 32) : GOTO 4000
5070 IF A$ = "4" THEN POKE $D6AE, (PEEK($D6AE) XOR 64) : GOTO 4000
5080 IF A$ = "5" THEN POKE $D6AE, (PEEK($D6AE) XOR 128) : GOTO 4000
